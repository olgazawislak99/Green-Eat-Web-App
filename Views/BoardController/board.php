...
<div class="container">
    <div class="board">
        ...
        <div class="wraper">
            ...
            <div class="div4"><a href="/?page=description&amp;name=<?=$post->getName()?>"><?=$post->getName() ?></a></div>
            ...
            <div class="div8"><button onclick="addLike()"><i class="fas fa-thumbs-up"></i></button></div>
        </div>
        <?php endforeach?>
